...
use backend\models\TestiSearch;
...
/**
 * TestiController implements the CRUD actions for Testi model.
 */
class TestiController extends Controller
{
    ...
    {
        if (($model = Testi::findOne(['id' => $id])) !== null) {
            return $model;
        }
